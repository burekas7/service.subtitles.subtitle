...
from SUBUtilities import SubtitleHelper, log, normalizeString, clear_cache, parse_rls_title, clean_title
...
def download(id, filename, stack=False):
    subtitle_list = []
    exts = [".srt", ".sub"]
    ...
    helper = SubtitleHelper()
    helper.download(id, zip_filename)
